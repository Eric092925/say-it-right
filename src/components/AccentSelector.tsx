...
interface AccentSelectorProps {
  value: AccentOption;
  onChange: (accent: AccentOption) => void;
  disabled?: boolean;
}

export default function AccentSelector({ value, onChange, disabled }: AccentSelectorProps) {
  return (
    <div className="relative inline-flex items-center">
      ...
      <div className="relative w-full">
        <select
          id="accent-select"
          value={value}
          onChange={(e) => onChange(e.target.value as AccentOption)}
          disabled={disabled}
