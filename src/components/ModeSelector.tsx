...
import { Mic, MessageSquareText, Headphones } from "lucide-react";
    ...
    <div className="flex justify-center mb-8">
      <div className="inline-flex p-1.5 rounded-2xl bg-slate-200/80 dark:bg-slate-800/80 border border-slate-300/60 dark:border-slate-700/60 shadow-inner">
        <button
          ...
          className={`flex items-center gap-2 px-4 sm:px-6 py-2.5 rounded-xl font-semibold text-xs sm:text-sm transition-all duration-200 ${
            mode === "word"
